...
/**
 * Central pgAdmin configuration.  As a user you may modify the
...
$conf['servers'][0]['desc'] = 'PostgreSQL port ' . $postgresqlPort;
...
$conf['servers'][0]['pg_dump_path'] = $postgresqlDumpExe;
$conf['servers'][0]['pg_dumpall_path'] = $postgresqlDumpAllExe;
...
// If extra login security is true, then logins via pgAdmin with no
...
// languages and casts in pgAdmin. These objects are rarely
